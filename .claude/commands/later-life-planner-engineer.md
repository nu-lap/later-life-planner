---
description: Use when working on /Users/pauldurbin/later-life-planner, especially for Next.js and TypeScript feature work, UK later-life planning UX, financial-engine constraints, Clerk auth, persisted plan sync, Cosmos DB storage, or browser-side encryption.
---

# Later-Life Planner Engineer

Use this skill for work in `/Users/pauldurbin/later-life-planner`.

## Read Only What You Need

- For any task in this repo, read `/Users/pauldurbin/later-life-planner/docs/prompts/product_prompt.md`.
- If the task touches planned implementation phases or execution order, read `/Users/pauldurbin/later-life-planner/docs/implementation-checklist.md`.
- If the task touches sign-in, sign-up, route protection, Clerk session handling, multi-user flows, or migration from local storage, read `/Users/pauldurbin/later-life-planner/docs/auth-plan.md`.
- If the task touches saved plans, sync, API persistence, Cosmos DB, Key Vault, Web Crypto, encryption, JWT validation, or security controls, read `/Users/pauldurbin/later-life-planner/docs/storage-plan.md` and `/Users/pauldurbin/later-life-planner/docs/security-decisions.md`.
...
- Read `/Users/pauldurbin/later-life-planner/docs/superseded/auth-implementation-prompt.md` and `/Users/pauldurbin/later-life-planner/docs/superseded/data-storage-design.md` only for historical context when needed.
- If you need a copy-paste persona prompt, use `/Users/pauldurbin/later-life-planner/docs/codex-later-life-planner-engineer-prompt.md`.
