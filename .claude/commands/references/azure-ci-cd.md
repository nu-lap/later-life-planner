...
This reference captures the current automated deployment path for `/Users/pauldurbin/later-life-planner`.

## Current Deployment Topology

- Source control: GitHub
- CI runner: GitHub Actions
- Container registry: Azure Container Registry `acrblackdog69llp`
