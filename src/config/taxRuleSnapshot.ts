...
//                        (exemptAmount escalated 4%/yr beyond 2026-27; rates unchanged)
//   isa_allowance     → confirmed through 2026-27 (£20,000 since 2017); escalated 4%/yr
...
// TAX_BAND_ESCALATION_RATE (4%/yr), matching the Voyant Default Tax Table
...
export const LATEST_CGT_CALENDAR_YEAR  = 2026; // last confirmed: 2026-27
export const LATEST_ISA_CALENDAR_YEAR  = 2026; // last confirmed: 2026-27

// ISA annual contribution allowance: £20,000 since tax year 2017-18, confirmed
// through 2026-27. Source: HMRC — https://www.gov.uk/individual-savings-accounts
export const ISA_ANNUAL_ALLOWANCE_BASE  = 20_000;
...
export interface ResolvedSnapshot {
  ...
  /** ISA annual contribution allowance (£). Confirmed through 2026-27; escalated at 4%/yr thereafter. */
  isaAnnualAllowance: number;
  /** true if cgt entry for the requested year was absent; escalated from 2026-27 baseline instead. */
  cgtFallback: boolean;
 ...
 *  - CGT exempt amount: confirmed through 2026-27. For later years, escalated at
 *    TAX_BAND_ESCALATION_RATE (4%/yr) from the 2026-27 baseline.
 *    CGT rates (18%/24%) are never escalated.
 *  - ISA annual allowance: confirmed through 2026-27 (£20,000). For later years, escalated
 *    at TAX_BAND_ESCALATION_RATE (4%/yr) from the 2026-27 baseline.
...
export function getSnapshotForYear(calendarYear: number): ResolvedSnapshot {
  ...
  // CGT: confirmed only through 2026-27.
  // Beyond the last confirmed year, escalate exemptAmount at TAX_BAND_ESCALATION_RATE
  // (4%/yr) from the 2026-27 baseline — matching Voyant's Default Tax Table Assumption.
  ...
  // ISA annual allowance: confirmed through 2026-27 (£20,000).
  // Beyond the last confirmed year, escalate at TAX_BAND_ESCALATION_RATE (4%/yr).
  ...
  if (process.env.NODE_ENV !== 'test') {
    ...
    if (cgtFallback) {
      warn(
        ...
        `Escalating exemptAmount at ${TAX_BAND_ESCALATION_RATE * 100}%/yr from 2026-27 baseline. ` +
