          ...
          <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4">
            ...
            {activeStrategy === 'pcls-bed-isa' && (
              <div className="mt-3 pt-3 border-t border-slate-200 flex flex-wrap items-center gap-3">
                ...
                <p className="text-xs text-slate-500">
                  Min {nmpa} (<span className="inline-flex items-center">NMPA<InfoIcon term="NMPA" tooltip={GLOSSARY.NMPA} /></span>{pclsCalYear >= PENSION_RULES.NMPA_RISE_YEAR ? ' from 2028' : ''}) ·{' '}
