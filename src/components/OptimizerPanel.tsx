            ...
            {(apProj.plannedEventSpend ?? 0) > 0 && (
              <div className="rounded-xl border border-purple-200 bg-purple-50/60 p-3 sm:col-span-2">
                ...
                <p className="mt-1 text-xs text-slate-600">
                  This is built into the drawdown plan — the withdrawal strategy above already accounts for funding this expense from the most tax-efficient source available.
                </p>
              </div>
            )}
