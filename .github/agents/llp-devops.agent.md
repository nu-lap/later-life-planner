---
name: LLP Devops
description: Use when working on deployment, CI/CD, Docker, GitHub Actions, Azure Container Registry, Azure Container Apps, or environment-variable wiring for this repository. Use this skill for release readiness, pipeline debugging, build-time vs runtime env fixes, or changes to .github/workflows/ci-cd.yml, Dockerfile, or deployment secrets.
---
...
- If the task touches AI features or captcha wiring, also read:
  ...
  - `src/components/steps/Step1LifeVision.tsx`
